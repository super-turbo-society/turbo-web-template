...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures__invoke8__h749ba1736476823b: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__h089b9cc2791d6346: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2__h3b7f84c79c4ac2c8: (a: number, b: number, c: number, d: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2__h77cb007ec23deefa: (a: number, b: number, c: number, d: number) => number;
  readonly _dyn_core__ops__function__Fn_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h66a8f087c40a3901: (a: number, b: number) => number;
  readonly wasm_bindgen__convert__closures__invoke6__hf8d8ef438075de83: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => number;
  readonly wasm_bindgen__convert__closures__invoke1__h2d17859fc2302ea8: (a: number, b: number, c: number) => number;
  readonly wasm_bindgen__convert__closures__invoke0_mut__h62144c8549583437: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h61d75cf130769dc9: (a: number, b: number, c: number, d: number) => void;
  readonly wasm_bindgen__convert__closures__invoke6__heb35c5c87b83ced0: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => void;
  readonly wasm_bindgen__convert__closures__invoke5__h156eabf381290da9: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1__h57b7f514cff7fb4f: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke4__h1127e1d7bb001a30: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__h6ef0fbeb3e682c2c: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__h0988869b23b4b48d: (a: number, b: number, c: number) => void;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hfdf2c89756a6bdc1: (a: number, b: number, c: number) => void;
  readonly __wbindgen_free: (a: number, b: number, c: number) => void;
  readonly __wbindgen_exn_store: (a: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h6b34c662dfd3bf3c: (a: number, b: number, c: number, d: number) => void;
}
