...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures__invoke8__hb534aac7608eba78: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2__h07064fc21f3dd3c8: (a: number, b: number, c: number, d: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__hbcf7159c0d0b2519: (a: number, b: number, c: number, d: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__h0cb66bedeb56ec52: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2__h9ed033f236d114c3: (a: number, b: number, c: number, d: number) => number;
  readonly wasm_bindgen__convert__closures__invoke0_mut__h5adb1da3fe3eacba: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke4__h3155aa101589eb58: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1__h0852ca76c8c39b9f: (a: number, b: number, c: number) => number;
  readonly wasm_bindgen__convert__closures__invoke6__hfb25de081dd04790: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => number;
  readonly wasm_bindgen__convert__closures__invoke5__hc6adde9ba5644793: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
  readonly _dyn_core__ops__function__Fn_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h3890ac200f01ad91: (a: number, b: number) => number;
  readonly wasm_bindgen__convert__closures__invoke1__h2a847104aeeea7c4: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke6__h75d559b7bbcba73f: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => void;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h1ac580d36f8c0bc7: (a: number, b: number, c: number) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h4da95a4c6445a545: (a: number, b: number) => void;
